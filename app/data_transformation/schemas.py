...
class TransformReq(BaseModel):
    ...
    source_path: Optional[str] = Field(
        default="s3://airbytedestination1/bronze/erp-production-orders-raw-production-orders.parquet",
        description="Optional specific S3 source path for testing",
    )
    ...
    model_config = {
        ...
        "json_schema_extra": {
            "example": {
                ...
                "source_path": "s3://airbytedestination1/bronze/erp-production-orders-raw-production-orders.parquet",
            }
        }
    }
